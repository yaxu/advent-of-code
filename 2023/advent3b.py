...
schematic = '''............677..........................................................................227.....730..35.......318...........92...166.......
...
for (y, line) in enumerate(lines):
    for match in re.finditer(r'\d+', line):
        number = match[0]
        numbers.append([match[0], match.start(), match.end(), y])
    for match in re.finditer(r'\*', line):
        stars.append([match.start(), y])

def touches(number, star):
    xstart = number[1]
    xend = number[2]
    y = number[3]
...
total = 0
for star in stars:
    friends = list(filter(lambda number: touches(number, star), numbers))
    if len(friends) == 2:
        total += int(friends[0][0]) * int(friends[1][0])
